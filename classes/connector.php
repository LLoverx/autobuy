<?php
	...
	class Connector {
    		...
    		private function GetUserAccounts($nucleusId, $url) {
        		...
        		} else if($this->_loginDetails['platform'] == "360") {
        			$this->_loginDetails['route'] = 'https://utas.fut.ea.com:443';
        		} else {
    		...
    		private function GetSessionId($nucleusId, $userAccounts, $url) {
        		...
        		$request->setHeader('Accept', 'application/json, text/javascript');
        		$request->setHeader('Accept-Language', 'en-US,en;q=0.8');
        		$request->setHeader('Referer', 'http://www.easports.com/iframe/fut/?baseShowoffUrl=http%3A%2F%2Fwww.easports.com%2Fuk%2Ffifa%2Ffootball-club%2Fu	ltimate-team%2Fshow-off&guest_app_uri=http%3A%2F%2Fwww.easports.com%2Fuk%2Ffifa%2Ffootball-club%2Fultimate-team&locale=en_GB');
